...
async function getData(householdId: string) {
  ...
  const [slotsRes, allSlotsRes, cutsRes, prepRes, expensesRes, paymentsRes, suggestionsRes, statusRes] =
    await Promise.all([
      supabase
        .from("slots")
        ...
        .order("slot_number"),
      supabase.from("slots").select("id, is_claimed").order("slot_number"),
...
export default async function MyOrderPage() {
  ...
  const {
    slots, totalSlots, availableSlots, prepOptions,
